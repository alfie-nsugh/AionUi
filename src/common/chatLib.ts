...
type TMessageType = 'text' | 'tips' | 'tool_call' | 'tool_group' | 'agent_status' | 'acp_notice' | 'acp_permission' | 'acp_tool_call' | 'codex_permission' | 'codex_tool_call';
...
export type IMessageAcpNotice = IMessage<
  'acp_notice',
  {
    message: string;
...
export type TMessage = IMessageText | IMessageTips | IMessageToolCall | IMessageToolGroup | IMessageAgentStatus | IMessageAcpNotice | IMessageAcpPermission | IMessageAcpToolCall | IMessageCodexPermission | IMessageCodexToolCall;
